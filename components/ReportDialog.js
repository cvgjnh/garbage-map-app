...
export function ReportDialog(props) {
  ...
  const handleSubmit = () => {
    ...
    firestore()
      ...
      .then(() => {
        Alert.alert('Report successfully submitted!', '', [{ text: 'OK' }]);
        clearFieldsAndClose();
      });
  };
  ...
  return (
    <Portal>
      <Dialog
        ...
        style={styles.dialog}
      >
        <Dialog.Title>Report inappropriate marker characteristics</Dialog.Title>
        <Dialog.Content>
          <View style={styles.row}>
            <Checkbox
              status={inappropriateTitle ? 'checked' : 'unchecked'}
              onPress={() => {
          ...
          <View style={styles.row}>
            <Checkbox
              status={inappropriateImage ? 'checked' : 'unchecked'}
              onPress={() => {
          ...
          <View style={styles.row}>
            <Checkbox
              status={inappropriateDescription ? 'checked' : 'unchecked'}
              onPress={() => {
                setInappropriateDescription(!inappropriateDescription);
              }}
            />
            <Text variant="labelLarge"> Inappropriate Description</Text>
          </View>
          <View style={styles.row}>
            <Checkbox
            ...
            />
            <Text variant="labelLarge"> Not a Public Waste Bin</Text>
          </View>
          {chooseOneWarning && (
            <Text style={styles.warning} variant="labelLarge">
              Please select at least one inappropriate characteristic to submit
              a report
            </Text>
          )}
        ...
        <Dialog.Actions>
          <Button onPress={() => clearFieldsAndClose()}> Cancel </Button>
